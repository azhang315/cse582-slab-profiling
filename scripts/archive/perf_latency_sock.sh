...
sudo perf record -e kmem:kmalloc,kmem:kfree -a -o "$DATA_DIR/perf.data" -- stress-ng --sock 10 --timeout 1s
...
python3 ./plotting/latency_plot_discrete.py "$DATA_DIR/perf_script_output.txt"
