...
RAW_DATA_DIR="$DATA_DIR/hdd/raw"
LOCAL_RAW_DATA_DIR="/data/tmp_latency/${KERNEL_VERSION}/hdd/raw"  # Local VM temp dir
MOUNT_DATA_DIR="./data/latency/${KERNEL_VERSION}/hdd/raw"        # Mount directory for final data storage
...
for i in $(seq 1 $NUM_RUNS); do
    ...
    sudo perf record -e kmem:kmalloc,kmem:kfree -a -o "$LOCAL_PERF_DATA_FILE" -- stress-ng --hdd 1 --timeout 1s
